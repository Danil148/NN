...
def get_answer_for_question(question: str, knowledge_base: dict) -> str or None:
    i = 0
    for el in range(len(knowledge_base['questions'])):
        if knowledge_base['questions'][i]['question'] == question:
...
def chat_bot():
    ...
    while True:
        ...
        if user_input.lower() == "quit":
            break
        best_match: str or None = find_best_match(
        ...
        if best_match:
            ...
            print("I dont know the answer. Please teach me")
            new_answer: str = input("Write the answer or 'skip' to skip: ")
            ...
            if new_answer.lower() != "skip":
                ...
                print("Bot: THX! I have learnt a new response")
